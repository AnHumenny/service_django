...
class BaseStationAdminForm(forms.ModelForm):
    """Custom form for BaseStation model in admin interface.."""
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'city' in self.fields:
            ...
            logger.error("[ERROR] Field 'city' not found in BaseStationAdminForm self.fields during __init__")
...
class BaseStationAdmin(admin.ModelAdmin):
    """Admin configuration for BaseStation model."""
